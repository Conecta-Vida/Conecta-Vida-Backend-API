  ...
  useEffect(() => {
    const carregarDados = async () => {
      try {
        ...
        console.log("Iniciando com formulário vazio ou carregando mock...");
      }
    };
    carregarDados();
  }, []);
        ...
        <Card className="border-none shadow-sm">
          ...
          <CardContent className="space-y-4 pt-6">
            <div className="space-y-1.5">
              <Label htmlFor="nome">Nome do Posto / UBS</Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="tel"><div className="flex items-center gap-1"><Phone className="w-3 h-3"/> Telefone</div></Label>
                <Input id="tel" value={form.telefone} onChange={(e) => setForm({ ...form, telefone: e.target.value })} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="email"><div className="flex items-center gap-1"><Mail className="w-3 h-3"/> E-mail</div></Label>
